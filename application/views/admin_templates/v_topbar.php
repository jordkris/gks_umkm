        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href="<?= base_url('admin'); ?>" class="text-center author"><img class="avatar border-gray preview_img" src="<?= base_url('assets/img/profile/').$profile['photo']; ?>" alt="..." width="60" height="60"/></a>
                    </li>
                    <li>
