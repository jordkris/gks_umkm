...
<script>
          ...
          var reader = new FileReader();
           ...
           reader.onloadend = function() {
              ...
              $.ajax({
                  type: "POST",
                  dataType: "json",
                  url: "<?= base_url('admin/upload_photo/'.$random_str); ?>",
  ...
  function redir() {
    window.open('<?= base_url('admin/preview_news/'.$random_str); ?>','_self');
  }

  function back() {
    window.open('<?= base_url('admin/news/0'); ?>','_self');
  }
</script>
</body>
</html>