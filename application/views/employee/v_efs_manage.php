...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-table"></i> EFS Data</h6>
    </div>
    <div class="card-body">
      <div class="table-responsive">
          <table class="table table-bordered table-striped display select cell-border" id="efs_table" width="100%" cellspacing="0" style="zoom: 60%;">
          <thead>
            <tr align="center">
              <th>ID Link</th>
              <th>No Berkas</th>
